...
/**
 * Das Modul "Eingabeformular" ist für das Eingabeformular zuständig.
...
/**
 * Die Klasse "Eingabeformular" stellt alle Eigenschaften und Methoden des Eingabeformulars
 * (inklusive HTML und Events) zur Verfügung
 */
export default class Eingabeformular {
   ...
   * dem Submit-EveFehlernt des Eingabeformulars.
   * @param  {Event} submit_event - das Submitevent des Eingabeformulars
